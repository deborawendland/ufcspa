...
def uniformCostSearch(problem):
    ...
    queue.push((start_node, new_action, cost), priority)

    while not queue.isEmpty():

        current_node, actions, prev_cost = queue.pop()
        if current_node not in visited_nodes:
            visited_nodes.append(current_node)
            ...
            for next_node, action, cost in problem.getSuccessors(current_node):
                new_action = actions + (action,)
                priority = prev_cost + cost
                queue.push((next_node, new_action, priority), priority)
    util.raiseNotDefined()
    ...
    while not queue.isEmpty():
        ...
        if current_node not in visited_nodes:
            ...
            for next_node, action, cost in problem.getSuccessors(current_node):
                ...
                queue.push((next_node, new_action, new_cost_to_node), heuristic_cost)
